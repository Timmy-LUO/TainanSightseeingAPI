...
class IntroductionTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: PropertyKeys.introductionCell, for: indexPath) as! IntroductionTableViewCell
        let introduction = tourismItem[indexPath.row]
        cell.introductionLabel.text = introduction.introduction
